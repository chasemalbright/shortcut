...
private:
    ...
    /* The queue of items in the buffer // shouldnt change
	...
	// condition variables? for push and pop
	    //1
	std::condition_variable pushReady; // push signal
		//2
	std::condition_variable popReady; // pop signal
