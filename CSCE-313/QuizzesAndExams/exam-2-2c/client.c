...
int main(int argc, char *argv[])
{
    ...
    */
    // TODO
    sockfd = socket(AF_INET, SOCK_STREAM, 0); // create the scoket
    if (sockfd < 0)
    ...
    */
    ...
    server_address.sin_family = AF_INET; // setting for ipv4
    ...
    connect(sockfd,(struct sockaddr *)&server_address,INET_ADDRSTRLEN); // connect similiar to bind in server
